...
then
  ...
  tests="IT_HarmOsc_1D IT_HarmOsc_1D_project_rot IT_Morse_1D IT_HarmOsc_2D_sym IT_HarmOsc_2D_asym IT_HarmOsc_3D_sym IT_HarmOsc_3D_asym IT_HarmOsc_3D_spherical RT_HarmOsc_1D RT_Tully1_1D"
fi
