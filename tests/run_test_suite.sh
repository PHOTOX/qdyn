...
then
  tests="IT_HarmOsc_1D IT_Morse_1D IT_HarmOsc_2D_asym IT_HarmOsc_3D_asym RT_Tully1_1D RT_DoubleWell_1D RT_LaserPulse_CH3I_1D
  RT_3state_Tully1_1D RT_Autocorrelation_OH_1D EF_LaserPulse_OH_1D"
else
  ...
  RT_Autocorrelation_OH_1D EF_LaserPulse_OH_1D"
fi
